...
export default function InstrumentsBancairesPage() {
  ...
  const instruments = lang === 'fr'
    ? [
        { icon: Shield, code: 'BG', title: 'Bank Guarantee (BG)', description: "Garantie bancaire de premier rang sécurisant une transaction ou un financement. Émise par la banque de l'émetteur au bénéfice du créancier, elle constitue un engagement irrévocable de paiement." },
        { icon: FileSearch, code: 'SBLC', title: 'SBLC', description: "Instrument de crédit documentaire émis par la banque du client au bénéfice du prêteur, garantissant le remboursement. La Standby Letter of Credit est largement reconnue dans les transactions financières internationales." },
        { icon: Send, code: 'MT799', title: 'MT799 / POF', description: "Message SWIFT attestant de la disponibilité et du contrôle effectif des fonds, requis en due diligence. Ce message de preuve de fonds est émis par la banque de l'émetteur avant toute transaction." },
        { icon: Lock, code: 'MT760', title: 'MT760', description: "Message SWIFT bloquant un instrument bancaire en faveur d'un bénéficiaire désigné. Ce message formalise le nantissement de l'instrument et garantit sa disponibilité exclusive." },
        { icon: Layers, code: 'CF', title: 'Collateral First', description: "Le client apporte une BG couvrant 3 % du besoin, complétée par une contre-garantie partenaire permettant la levée de fonds. Cette structure optimise l'effet de levier tout en limitant l'exposition initiale." },
        { icon: TrendingUp, code: 'TFI', title: 'International Trade Finance', description: "Fonds sur compte séquestre : les opérations de titres génèrent le financement sans consommer les fonds bloqués. Ce mécanisme permet de mobiliser des ressources sans immobilisation du capital." },
      ]
    : [
        { icon: Shield, code: 'BG', title: 'Bank Guarantee (BG)', description: "First-ranking bank guarantee securing a transaction or financing. Issued by the issuer's bank in favour of the creditor, it constitutes an irrevocable payment commitment." },
        { icon: FileSearch, code: 'SBLC', title: 'SBLC', description: "Documentary credit instrument issued by the client's bank in favour of the lender, guaranteeing repayment. The Standby Letter of Credit is widely recognised in international financial transactions." },
        { icon: Send, code: 'MT799', title: 'MT799 / POF', description: "SWIFT message attesting the availability and effective control of funds, required in due diligence. This proof of funds message is issued by the issuer's bank before any transaction." },
        { icon: Lock, code: 'MT760', title: 'MT760', description: "SWIFT message blocking a banking instrument in favour of a designated beneficiary. This message formalises the pledge of the instrument and guarantees its exclusive availability." },
        { icon: Layers, code: 'CF', title: 'Collateral First', description: "The client provides a BG covering 3% of the need, supplemented by a partner counter-guarantee enabling fund raising. This structure optimises leverage while limiting initial exposure." },
        { icon: TrendingUp, code: 'TFI', title: 'International Trade Finance', description: "Funds held in escrow: securities operations generate financing without consuming the blocked funds. This mechanism enables resources to be mobilised without tying up capital." },
      ];

  const accessConditions = lang === 'fr'
    ? [
        { icon: Building2, label: 'Établissement bancaire agréé', value: 'Banque de premier rang reconnue internationalement' },
        { icon: UserCheck, label: 'KYC / AML complet', value: "Vérification d'identité et conformité anti-blanchiment obligatoires" },
        { icon: Shield, label: 'Contrôle effectif des actifs', value: 'Preuve de propriété et de disponibilité des instruments fournis' },
        { icon: FileSearch, label: 'Dossier de conformité préalable', value: 'Documentation complète soumise avant toute mise en relation' },
      ]
    : [
        { icon: Building2, label: 'Licensed banking institution', value: 'Internationally recognised first-tier bank' },
        { icon: UserCheck, label: 'Full KYC / AML', value: 'Mandatory identity verification and anti-money laundering compliance' },
        { icon: Shield, label: 'Effective asset control', value: 'Proof of ownership and availability of provided instruments' },
        { icon: FileSearch, label: 'Prior compliance file', value: 'Complete documentation submitted before any introduction' },
      ];
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10 xl:px-16">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 text-base max-w-xl mx-auto">
              {lang === 'fr' ? "Chaque instrument est sélectionné selon la nature du financement et le profil de l'émetteur." :'Each instrument is selected according to the nature of the financing and the issuer profile.'}
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10 xl:px-16">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 text-base max-w-xl mx-auto">
              {lang === 'fr' ? "L'accès aux montages de garantie est réservé aux clients répondant aux critères de conformité suivants."
