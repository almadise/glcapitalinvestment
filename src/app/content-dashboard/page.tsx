...
export default function ContentDashboardPage() {
  ...
  const kpis = [
    ...
    },
    {
      ...
      bg: 'bg-emerald-50',
      href: '/content-dashboard/articles',
    },
    {
      label: 'Glossaire',
      value: stats.glossaire,
      icon: BookOpen,
      color: 'text-purple-600',
      bg: 'bg-purple-50',
      href: '/content-dashboard/glossaire',
    },
  ];
  ...
  const quickLinks = [
    {
      ...
      href: '/content-dashboard/pages',
      icon: FileText,
      desc: 'Créer et modifier les pages du site',
    },
    {
      label: 'Gérer la FAQ',
      href: '/content-dashboard/faq',
    ...
    },
    {
      ...
      href: '/content-dashboard/articles',
      icon: Newspaper,
      desc: 'Publications et actualités',
    },
    {
      label: 'Gérer le Glossaire',
      href: '/content-dashboard/glossaire',
      icon: BookOpen,
      desc: 'Termes et définitions financières',
    },
  ];
    ...
    <ContentLayout>
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm">
          Gérez les pages, FAQ, articles et glossaire du portail
        </p>
      </div>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 flex items-start gap-3 mb-6">
        ...
        <div>
          ...
          <div className="text-purple-700 text-xs mt-0.5">
            Vous pouvez gérer les pages, FAQ, articles et le glossaire. L'accès aux dossiers KYC/AML
            est réservé aux rôles Compliance et Analyste.
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {kpis.map((kpi) => (
            <Link
              key={kpi.label}
              href={kpi.href}
              className="bg-white rounded-xl border border-slate-200 p-5 hover:border-purple-200 hover:shadow-md transition-all group"
            >
              <div
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {quickLinks.map((link) => (
            <Link
              key={link.label}
              href={link.href}
              className="bg-white rounded-xl border border-slate-200 p-4 flex items-center gap-4 hover:border-purple-200 hover:shadow-md transition-all group"
            >
              ...
              <ArrowRight
                size={16}
                className="text-slate-400 group-hover:text-purple-600 transition-colors flex-shrink-0"
              />
            </Link>
          ))}
        </div>
