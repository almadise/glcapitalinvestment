...
export const metadata: Metadata = {
  ...
  description:
    'Structuration de dossiers de financement institutionnel : projet en euros, prêts commerciaux USD, programmes PPP et instruments SBLC/BG. Plateforme sécurisée pour porteurs de projets.',
  keywords:
    'financement institutionnel, placement privé PPP, prêt commercial, structuration dossier, SBLC, BG, MT-760, financement projet, KYC AML',
  alternates: { canonical: `${baseUrl}/home-page` },
  openGraph: {
    title: 'GL Capital Investment SA - Financement Institutionnel',
    description:
      'Plateforme institutionnelle sécurisée pour la structuration et le suivi de dossiers de financement.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'GL Capital Investment SA - Siège social',
      },
    ],
  },
  twitter: {
...
const organizationSchema = {
  ...
  description:
    'Plateforme de structuration et de présentation de dossiers de financement institutionnel. Services KYC/AML, instruments bancaires, financement de projets.',
  url: baseUrl,
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Structuration et présentation de dossiers de financement de projets d'infrastructure et d'investissement.",
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            'Structuration documentaire pour SBLC, BG et autres instruments de garantie bancaire.',
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            'Accompagnement stratégique pour la structuration financière et la présentation de dossiers.',
