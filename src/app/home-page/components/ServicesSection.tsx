  ...
  const services = [
    {
      ...
      descFr:
        "Structuration de projets d'infrastructure, d'énergie, d'immobilier et industriels. Nous préparons votre dossier pour soumission à des institutions financières agréées.",
      descEn:
        'Structuring for infrastructure, energy, real estate, and industrial projects. We prepare your dossier for submission to licensed financial institutions.',
    ...
    },
    {
      ...
      descFr:
        'Conseil et documentation pour SBLC, garanties bancaires et instruments connexes. Cadre clair, sans collecte de codes bancaires confidentiels.',
      descEn:
        'Advisory and documentation for SBLC, bank guarantees, and related instruments. Clear framework, with no collection of confidential banking codes.',
    ...
    },
    {
      ...
      descFr:
        'Évaluation de bancabilité, revue documentaire, pré-screening conformité et structuration de dossier avant soumission.',
      descEn:
        'Bankability assessment, document review, compliance pre-screening, and dossier structuring ahead of submission.',
    ...
    },
    {
      ...
      descFr:
        'Prêt commercial et de projet en USD. Résumé exécutif, caution d\'assurance et procédure détaillée sur la page dédiée.',
      descEn:
        'Commercial and project loans in USD. Executive summary, insurance surety bond, and full procedure on the dedicated page.',
      tagsFr: ['USD', 'Surety bond', 'USA/Vietnam/Dubaï'],
      tagsEn: ['USD', 'Surety bond', 'US/Vietnam/Dubai'],
      href: '/services/prets',
      delay: '0.45s',
    },
    {
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6" style={{ color: '#1E2D4A' }}>
            ...
            <span className="text-gradient-gold">
              {t('besoin de financement', 'financing need')}
            </span>
          </h2>
          <p className="max-w-2xl mx-auto" style={{ color: '#4A5C7A' }}>
            {t(
              "Des projets d'infrastructure aux instruments bancaires, prêts commerciaux et placement privé, GL Capital transforme votre demande en dossier exploitable par les institutions.",
              'From infrastructure projects to banking instruments, commercial loans, and private placement, GL Capital turns your request into an institution-ready dossier.'
            )}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {services?.map((service) => (
            ...
            >
              ...
              <span
                className="absolute top-6 right-6 text-[10px] font-mono px-2 py-0.5 rounded-full"
                style={{ color: '#B8912A', border: '1px solid #D8E0EC', background: '#F5EDD0' }}
              >
                {service?.badge}
              </span>
              <h3 className="text-xl font-bold mb-3" style={{ color: '#1E2D4A' }}>
                {t(service?.titleFr, service?.titleEn)}
              </h3>
              <p className="text-sm mb-6 leading-relaxed" style={{ color: '#4A5C7A' }}>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {(lang === 'en' ? service.tagsEn : service.tagsFr).map((tag) => (
                  <span
                    ...
                    style={{ color: '#4A5C7A', border: '1px solid #D8E0EC', background: '#E8EDF5' }}
                  >
                    {tag}
                  </span>
                ))}
