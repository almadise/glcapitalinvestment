  ...
  const steps = [
    {
      ...
      descFr: "Soumettez votre résumé exécutif. Notre équipe examine les critères d'éligibilité, la cohérence du projet et les prérequis de conformité.",
      descEn: "Submit your executive summary. Our team reviews eligibility criteria, project coherence and compliance prerequisites.",
    ...
    },
    {
      ...
      descFr: "Accord de non-divulgation mutuel signé. Cadre de confidentialité partenaire activé. Conditions d\'engagement définies.",
      descEn: "Mutual non-disclosure agreement signed. Partner confidentiality framework activated. Engagement terms defined.",
    ...
    },
    {
      ...
      descFr: "Screening KYC/AML complet. Vérification de l'exhaustivité des documents. Évaluation des risques : juridiction, secteur, sanctions, traçabilité des fonds.",
      descEn: "Full KYC/AML screening. Document completeness verification. Risk assessment: jurisdiction, sector, sanctions, fund traceability.",
    ...
    },
    {
      ...
      descFr: 'Analyse de bancabilité. Restructuration du dossier si nécessaire. Plan de financement formalisé et validé en interne.',
      descEn: 'Bankability analysis. File restructuring if needed. Financing plan formalized and internally validated.',
    ...
    },
    {
      ...
      descFr: 'Dossier transmis aux institutions financières agréées ou partenaires spécialisés sélectionnés. Client notifié via le portail.',
      descEn: 'File transmitted to selected licensed financial institutions or specialized partners. Client notified via the portal.',
      timingFr: 'Variable',
      timingEn: 'Variable',
      delay: 0.4,
    },
    {
      ...
      descFr: "Coordination des réponses institutionnelles, revue des term sheets, négociation des conditions. Clôture finale exécutée par l'institution.",
      descEn: "Coordination of institutional responses, term sheet review, conditions negotiation. Final closing executed by the institution.",
      timingFr: 'Variable',
      timingEn: 'Variable',
      delay: 0.5,
    },
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6" style={{ color: '#1E2D4A' }}>
            {t('De la demande à la', 'From Request to')}{' '}
            <span className="text-gradient-gold">{t('Clôture', 'Closing')}</span>
          </h2>
          <p className="max-w-2xl mx-auto" style={{ color: '#4A5C7A' }}>
            {t(
              "Un processus structuré et traçable de la soumission initiale à la revue de conformité jusqu'à la soumission institutionnelle.",
              "A structured and traceable process from initial submission through compliance review to institutional submission."
            )}
          </p>
        </div>
