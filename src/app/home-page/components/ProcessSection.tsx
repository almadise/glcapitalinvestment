...
export default function ProcessSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      descEn: 'Bankability analysis, dossier restructuring when needed, then formalization of the financing plan.',
    ...
    },
    {
      ...
      descEn: 'The dossier is sent to selected licensed financial institutions or specialized partners. The client is notified through the portal.',
      timingFr: 'Variable',
      timingEn: 'Variable',
      delay: 0.4,
    },
