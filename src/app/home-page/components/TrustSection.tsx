  ...
  const trustCards = [
    {
      ...
      descFr:
        'Toutes les relations partenaires sont couvertes par NCNDA. Les noms et coordonnées des partenaires ne sont jamais communiqués aux clients.',
      descEn:
        'All partner relationships are covered by NCNDA. Partner names and contact details are never shared with clients.',
    },
    {
      icon: (
        <svg
      ...
      descFr:
        'Chaque dossier passe un screening KYC/AML, des vérifications de sanctions et un contrôle PPE avant toute soumission.',
      descEn:
        'Every application goes through KYC/AML screening, sanctions checks, and PEP verification before submission.',
    },
    {
      icon: (
        <svg
      ...
      descFr:
        'Accès à un réseau sélectionné de banques agréées, de fonds spécialisés et de conseillers en finance structurée dans plusieurs juridictions.',
      descEn:
        'Access to a selected network of licensed banks, specialized funds, and structured finance advisors across multiple jurisdictions.',
    },
    {
      icon: (
        <svg
      ...
      descFr:
        "Journaux d'audit immuables pour chaque action. Versioning des documents, historique des statuts et enregistrements de décision conservés.",
      descEn:
        'Immutable audit logs for every action. Document versioning, status history, and decision records are retained.',
    },
  ];
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
            ...
            >
              ...
              <div className="mb-3">
                <span
                  ...
                  style={{ color: '#B8912A', background: '#F5EDD0', border: '1px solid #D8E0EC' }}
                >
                  {t(card?.badgeFr, card?.badgeEn)}
                </span>
              </div>
              <h3 className="font-bold text-base mb-3" style={{ color: '#1E2D4A' }}>
        ...
        >
          <h3 className="text-red-600 font-bold text-base mb-4 flex items-center gap-2">
            <span>⚠️</span> {t('Ce que GL Capital ne fait PAS', 'What GL Capital does NOT do')}
          </h3>
