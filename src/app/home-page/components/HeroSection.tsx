    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: '#0D1B2E' }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center pt-24 pb-16 -translate-y-8 sm:-translate-y-10 lg:-translate-y-14">
        ...
        <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ border: '1px solid rgba(184,145,42,0.4)', background: 'rgba(184,145,42,0.12)' }}>
          ...
          <span className="text-[11px] sm:text-xs font-medium tracking-wide uppercase" style={{ color: '#EDD48A' }}>
            {t('PLATEFORME INSTITUTIONNELLE SÉCURISÉE', 'SECURE INSTITUTIONAL PLATFORM')}
          </span>
        </div>

        {/* Headline */}
        <h1 className={`text-2xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-6 transition-all duration-700 delay-150 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ color: '#FFFFFF' }}>
