...
import { contactProjectTypes, contactProjectTypeHints } from '@/lib/content/glCapitalRedactionnel';
...
export default function ContactLeadPage() {
  ...
  const projectTypeHint = formData.projectType
    ? contactProjectTypeHints[formData.projectType]
    : undefined;
  ...
  const t = {
    ...
    heroSubtitle:
      lang === 'fr'
        ? 'Vous avez une question ou souhaitez en savoir plus sur nos services ? Remplissez ce formulaire et notre équipe vous répondra sous 48h ouvrées.'
        : 'Have a question or want to learn more about our services? Fill in this form and our team will respond within 48 business hours.',
    ...
    messagePlaceholder:
      lang === 'fr'
        ? 'Décrivez brièvement votre demande ou question...'
        : 'Briefly describe your request or question...',
    ...
    successDesc:
      lang === 'fr'
        ? 'Un email de confirmation a été envoyé à votre adresse. Cliquez sur le lien pour finaliser votre demande.'
        : 'A confirmation email has been sent to your address. Click the link to complete your request.',
    successNote:
      lang === 'fr'
        ? 'Ce lien est valable 24 heures. Vérifiez également vos spams.'
        : 'This link is valid for 24 hours. Also check your spam folder.',
    ...
    doubleOptInNote:
      lang === 'fr'
        ? '🔒 Votre email sera vérifié avant enregistrement (double opt-in RGPD).'
        : '🔒 Your email will be verified before registration (GDPR double opt-in).',
  };
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, rgba(30,45,74,0.90) 0%, rgba(30,45,74,0.82) 60%, rgba(42,61,92,0.75) 100%)',
            }}
          />
          <div className="max-w-screen-xl mx-auto px-6 lg:px-10 xl:px-16 relative z-10">
            ...
            <p
              className="text-white/80 text-lg leading-relaxed max-w-2xl pl-5"
          ...
          <div className="max-w-screen-xl mx-auto px-6 lg:px-10 xl:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <aside className="lg:col-span-1 space-y-6" aria-label="Informations de contact">
                ...
                >
                  <h2 className="font-display font-bold text-base" style={{ color: '#1E2D4A' }}>
                    {ENTITY_GL_CAPITAL}
                  </h2>
                  ...
                  <div className="space-y-3 text-sm mt-3" style={{ color: '#4A5C7A' }}>
                    <div className="flex items-start gap-2.5">
                      ...
                      <div>
                        <div
                          className="font-semibold text-xs uppercase tracking-wider mb-0.5"
                          style={{ color: '#1E2D4A' }}
                        >
                          Email
                        </div>
                ...
                >
                  <p className="text-xs leading-relaxed" style={{ color: '#1E2D4A' }}>
                    {t.doubleOptInNote}
                  </p>
                </div>
              </aside>
              ...
              <div className="lg:col-span-2">
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-base max-w-md mx-auto mb-3" style={{ color: '#4A5C7A' }}>
                      {t.successDesc}
                    </p>
                    <p className="text-sm max-w-sm mx-auto" style={{ color: '#6B7E9A' }}>
                      {t.successNote}
                    </p>
                  </div>
                ) : (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            style={{
                              background: '#F7F8FA',
                              border: '1px solid #D8E0EC',
                              color: formData.projectType ? '#1E2D4A' : '#6B7E9A',
                            }}
                          >
                        ...
                        {projectTypeHint && (
                          <p
                            className="text-xs leading-relaxed mt-2 pl-1"
                            style={{ color: '#4A5C7A' }}
                          >
                            {lang === 'fr'
                              ? projectTypeHint.message.fr
                              : projectTypeHint.message.en}{' '}
                            <Link
                              href={projectTypeHint.href}
                              className="font-semibold hover:underline"
                              style={{ color: '#B8912A' }}
                            >
                              {lang === 'fr'
                                ? projectTypeHint.linkLabel.fr
                                : projectTypeHint.linkLabel.en}
                            </Link>
                          </p>
                        )}
                      </div>
