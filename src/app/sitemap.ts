...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/services/financement-international`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    ...
    { url: `${baseUrl}/services/placement-prive`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${baseUrl}/services/prets`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${baseUrl}/services/conseil-crypto`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${baseUrl}/services/structuration-financiere`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/qui-sommes-nous`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/securite-conformite`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
