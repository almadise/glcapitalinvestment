      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">
              {lang === 'fr'
                ? 'Tous les événements système - filtrez par utilisateur, action et plage de dates.'
                : 'All system events - filter by user, action, and date range.'}
            </p>
          </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-center gap-3 mb-5 text-xs text-amber-800">
          ...
          <span>
            ...
            {lang === 'fr'
              ? 'Ce journal contient des données sensibles. Réservé aux rôles Admin et Compliance.'
              : 'This log contains sensitive data. Reserved for Admin and Compliance roles.'}
          </span>
        </div>
        ...
        <div className="flex items-center gap-4 mb-4 text-xs text-slate-500">
          <span className="font-semibold text-navy">
            {total.toLocaleString()} {lang === 'fr' ? 'événements' : 'events'}
          </span>
          <span>·</span>
          <span>
            {lang === 'fr'
                      ...
                      <React.Fragment key={log.id}>
                        <tr className="hover:bg-slate-50 transition-colors">
                          <td className="px-4 py-3">
                            <span
                              className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full border text-[10px] font-semibold ${cfg.bg} ${cfg.color}`}
                            >
                              <ActionIcon size={10} />
                              {cfg.label}
                            </span>
