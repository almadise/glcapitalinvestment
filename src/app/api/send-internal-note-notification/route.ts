...
export async function POST(req: NextRequest) {
  ...
  const {
    caseTitle, caseRef, caseId, authorEmail, noteContent, caseStatus,
    internalRecipients = [],
  } = body;
  ...
  const html = buildInternalNoteHtml({ caseTitle, caseRef: caseRef || caseId, caseId, authorEmail, noteContent, caseStatus });
