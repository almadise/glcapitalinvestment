...
export default function ServicesComparisonTable() {
  ...
  const comparisonRows = [
    {
      id: 'cr-1',
      featureFr: "Montant minimum d'engagement",
      featureEn: 'Minimum engagement amount',
      pf: '€5M+',
      bi: '€1M+',
      adv: 'Custom',
    },
    {
      id: 'cr-2',
      featureFr: 'KYC/AML requis',
      featureEn: 'KYC/AML required',
      pf: 'full',
      bi: 'full',
      adv: 'partial',
    },
    {
      id: 'cr-3',
      featureFr: 'Préparation documentaire incluse',
      featureEn: 'Document preparation included',
      pf: 'yes',
      bi: 'yes',
      adv: 'yes',
    },
    {
      id: 'cr-4',
      featureFr: 'Soumission institutionnelle',
      featureEn: 'Institutional submission',
      pf: 'yes',
      bi: 'yes',
      adv: 'no',
    },
    {
      id: 'cr-5',
      featureFr: 'Confidentialité partenaire (NCNDA)',
      featureEn: 'Partner confidentiality (NCNDA)',
      pf: 'yes',
      bi: 'yes',
      adv: 'yes',
    },
    {
      id: 'cr-6',
      featureFr: 'Approbation garantie',
      featureEn: 'Guaranteed approval',
      pf: 'no',
      bi: 'no',
      adv: 'no',
    },
    {
      id: 'cr-7',
      featureFr: "Durée d'engagement type",
      featureEn: 'Typical engagement duration',
      pf: t('30–90 jours', '30–90 days'),
      bi: t('14–45 jours', '14–45 days'),
      adv: t('7–21 jours', '7–21 days'),
    },
    {
      id: 'cr-8',
      featureFr: 'Exécution du financement',
      featureEn: 'Financing execution',
      pf: 'no',
      bi: 'no',
      adv: 'no',
    },
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">
            {t(
              ...
              'All three service lines follow the same compliance and confidentiality standards'
            )}
          </p>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-navy-900">
                  <th className="px-6 py-4 text-left text-xs font-semibold text-white/60 uppercase tracking-wider w-1/3">
                    {t('Caractéristique', 'Feature')}
                  </th>
              ...
              <tbody className="divide-y divide-gray-100">
                {comparisonRows.map((row) => (
                  <tr key={row.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-3.5 text-sm font-medium text-navy-800">
                      {t(row.featureFr, row.featureEn)}
                    </td>
