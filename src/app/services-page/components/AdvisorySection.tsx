  ...
  const advisoryServices = [
    {
      ...
      descEn:
        'Independent review of your project or transaction against institutional lending criteria. Identifies gaps before formal submission.',
    ...
    },
    {
      ...
      descEn:
        'Complete review and restructuring of the application package: executive summary, business plan, financial model, and KYC.',
    ...
    },
    {
      ...
      descEn:
        'Pre-submission compliance check: identity verification, sanctions screening, PEP review, and source-of-funds validation.',
    ...
    },
    {
      ...
      descEn:
        'Review and optimization of debt/equity structure, guarantee package, and institutional submission strategy.',
  ...
  const forWhom = [
    {
      ...
      descEn:
        'Companies or project sponsors seeking institutional financing for the first time and needing clear documentation guidance.',
    },
    {
      id: 'for-2',
      ...
      descEn:
        'Projects rejected by banks or DFIs that require analysis of rejection causes and a remediation plan.',
    },
    {
      id: 'for-3',
      ...
      descEn:
        'SPVs, joint ventures, or multi-jurisdiction projects that require specialized structuring expertise.',
    },
  ];
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
          <div className="flex items-start gap-6">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-2" style={{ color: '#1E2D4A' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {advisoryServices?.map((svc) => (
            <div
              key={svc?.id}
              className="rounded-2xl p-6 shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300"
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium" style={{ color: '#4A5C7A' }}>
                    {t(svc?.deliverableFr, svc?.deliverableEn)}
                  </span>
                </div>
                <div
        ...
        <div className="rounded-2xl p-8 mb-8" style={{ background: '#1E2D4A' }}>
          <h3 className="text-white font-bold text-lg mb-6">
            {t(
              ...
              'Who Is Advisory & Structuring For?'
            )}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {forWhom?.map((item) => (
              <div key={item?.id}>
                <h4 className="font-semibold text-sm mb-2" style={{ color: '#B8912A' }}>
