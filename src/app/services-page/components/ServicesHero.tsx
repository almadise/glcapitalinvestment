    ...
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-screen-2xl mx-auto px-6 lg:px-10 text-center">
        ...
        <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
          {t('Solutions de financement', 'Financing Solutions')}
          <br />
          <span className="text-gradient-gold">
            {t('Adaptées aux montages complexes', 'Designed for complex deal structures')}
          </span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <Link
            ...
            className="flex items-center gap-2 px-6 py-3 font-semibold rounded-xl transition-all duration-200 active:scale-95 text-sm"
            style={{ background: '#B8912A', color: '#FFFFFF' }}
          >
            {t('Financement de projet', 'Project Financing')} <ArrowRight size={14} />
          </Link>
          <Link
            href="#banking-instruments"
            className="px-6 py-3 text-white font-semibold rounded-xl border border-white/25 transition-all duration-200 text-sm backdrop-blur-sm hover:bg-white/10"
          >
            {t('Instruments bancaires', 'Banking Instruments')}
          </Link>
          <Link
            href="#advisory"
            className="px-6 py-3 text-white/80 hover:text-white font-medium transition-colors text-sm"
          >
