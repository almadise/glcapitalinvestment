    ...
    <section className="py-20" style={{ background: '#1E2D4A' }}>
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10 text-center">
        ...
        <h2 className="text-4xl font-bold text-white mb-4">
          {t('Soumettez votre dossier aujourd\'hui', 'Submit Your Dossier Today')}
        </h2>
        <p className="text-white/60 max-w-xl mx-auto mb-8 text-sm leading-relaxed">
          {t(
            'Créez votre compte sécurisé, complétez l\'assistant de soumission, et notre équipe commencera le processus de revue sous 1–3 jours ouvrés.',
            'Create your secure account, complete the submission wizard, and our team will begin the review process within 1–3 business days.'
          )}
        </p>
